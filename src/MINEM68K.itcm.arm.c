...
DTCM_DATA struct regstruct regs;
...
LOCALVAR DTCM_DATA const func_pointer_t OpDispatch[kNumIKinds + 1] = {
	DoCodeTst /* kIKindTst */,
...
LOCALVAR DTCM_DATA const DecodeAddrP DecodeAddrDispatch[kNumAMds] = {
...
LOCALVAR DTCM_DATA const DecodeGetSrcDstP DecodeGetSrcDstDispatch[kNumAMds] = {
...
LOCALVAR const DTCM_DATA DecodeSetSrcDstP DecodeSetSrcDstDispatch[kNumAMds] = {
...
LOCALVAR DTCM_DATA const DecodeGetSetSrcDstP
...
LOCALVAR DTCM_DATA const cctrueP cctrueDispatch[CCdispSz + 1] = {
...
LOCALVAR DTCM_DATA const NeedLazyFlagP
...
LOCALIPROC Recalc_PC_Block(void)
{
	ATTep p;
